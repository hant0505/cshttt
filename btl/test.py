...
# # ===================================
# print(f"\nSimulating {NUM_LABELS_TO_SIMULATE} labels ...")

# for step in range(NUM_LABELS_TO_SIMULATE):
...
#     if (step + 1) % 10 == 0:
#         print("Labeled:", step+1)

# print("Finished labeling.")


# # ===================================
# # 4. Lấy user_labels từ /display
# # ===================================
...
# manual_label_dict = display_resp.get("user_labels", {})
# manual_labeled_ids = set(int(k) for k in manual_label_dict.keys())


# # ===================================
# # 5. Lấy auto-assign từ /get_topic_list
# # ===================================
...
# # Collect auto-assign docs
# auto_assign_list = []

# for pred_label, doc_ids in topic_docs.items():
#     for d in doc_ids:
#         if d not in manual_labeled_ids:
#             auto_assign_list.append((d, pred_label))

# print("Auto-assign docs:", len(auto_assign_list))


# # ===================================
# # 6. Tính PRECISION & COVERAGE
# # ===================================
# correct = 0

# for doc_id, pred_label in auto_assign_list:
#     if pred_label == gold_labels[doc_id]:
#         correct += 1

# precision = correct / len(auto_assign_list) if auto_assign_list else 0

# remaining_unlabeled = total_docs - NUM_LABELS_TO_SIMULATE
# coverage = len(auto_assign_list) / remaining_unlabeled if remaining_unlabeled else 0
...
# # ===================================
# print("\n========== RESULT ==========")
# print("Manual labels:", NUM_LABELS_TO_SIMULATE)
# print("Auto-assign docs:", len(auto_assign_list))
# print("Auto-assign precision:", round(precision, 4))
...
#     print(f"=== Running experiment: {num_labels} manual labels ===")
...
#         if (i + 1) % 10 == 0:
#             print(f"  labeled {i+1}/{num_labels}")
...
#     remaining = total_docs - num_labels
#     coverage = len(auto_list) / remaining if remaining > 0 else 0

#     print(f"Done {num_labels} labels: precision={precision:.4f}, coverage={coverage:.4f}\n")
